package com.huashanlunjian.script.entity.renderer.model;
...
@OnlyIn(Dist.CLIENT)
public class AnModel<T extends AnEntity> extends BipedModel<T> {
    ...
    boolean smallArmsIn = false;
    public AnModel(float modelSize) {
    ...
    public void setRotationAngles(T entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        //this.bipedDeadmau5Head.rotateAngleZ = 0.3F * MathHelper.sin(0.45F * ageInTicks);
        //this.bipedDeadmau5Head.rotateAngleX = 0.4F;
        //this.bipedDeadmau5Head.rotateAngleY = netHeadYaw * ((float)Math.PI / 180F);
        //this.bipedDeadmau5Head.rotateAngleX = headPitch * ((float)Math.PI / 180F);
        ...
        //    flag = ((AnEntity)entityIn).getShakeHeadTicks() > 0;
        //}
