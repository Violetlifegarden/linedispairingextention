...
public class EggExploderEntity extends ProjectileItemEntity {
    ...
    public EggExploderEntity(EntityType<? extends EggEntity> eggentity, World world) {
        super(eggentity, world);
    }

    public EggExploderEntity(World worldIn, LivingEntity throwerIn) {
        super(EntityType.EGG, throwerIn, worldIn);
    }

    public EggExploderEntity(World worldIn, double x, double y, double z) {
    ...
    public void tick() {
        ...
        if (!this.world.isRemote) {
            ...
            IronGolemEntity chickenentity = EntityType.IRON_GOLEM.create(this.world);
            ...
            List<Entity> list = world.getEntitiesInAABBexcluding
                    (chickenentity, new AxisAlignedBB(chickenentity.getPosX() - 30.0D,
                            chickenentity.getPosY() - 30.0D, chickenentity.getPosZ() - 30.0D,
                            chickenentity.getPosX() + 30.0D, chickenentity.getPosY() + 6.0D +
                            30.0D, chickenentity.getPosZ() + 30.0D), Entity::isAlive);
            ...
            for (Entity entity : list) {
                if (entity instanceof LivingEntity) {
                    ...
                    entity.attackEntityFrom(DamageSource.causeIndirectMagicDamage(chickenentity, chickenentity), 10);
                    entity.attackEntityFrom(DamageSource.causeMobDamage(chickenentity), (float)chickenentity.getAttributeValue(Attributes.ATTACK_DAMAGE));
            ...
            chickenentity.causeLightningStrike(Objects.requireNonNull(this.world.getServer()).func_241755_D_(), lightningBoltEntity);
        }
