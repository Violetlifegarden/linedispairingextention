...
import com.huashanlunjian.script.entity.ai.brain.task.MaidFarmMoveTask;
import com.huashanlunjian.script.entity.ai.brain.task.MaidFarmPlantTask;
...
public interface IFarmTask extends IMaidTask {
     ...
     * @return 是否可以收获
     */
    boolean canHarvest(AnEntity maid, BlockPos cropPos, BlockState cropState);
     ...
     * @param cropState 作物的 BlockState
     */
    void harvest(AnEntity maid, BlockPos cropPos, BlockState cropState);
     ...
     * @return 是否可以种植
     */
    boolean canPlant(AnEntity maid, BlockPos basePos, BlockState baseState, ItemStack seed);
     ...
     * @return 种植后返回的物品
     */
    ItemStack plant(AnEntity maid, BlockPos basePos, BlockState baseState, ItemStack seed);
     ...
     */
    @Override
    default SoundEvent getAmbientSound(AnEntity maid) {
     ...
     */
    @Override
    default List<Pair<Integer, Task<? super AnEntity>>> createBrainTasks(AnEntity maid) {
